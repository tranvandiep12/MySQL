...
-- Những học sinh có họ tên bắt đầu bằng Nguyễn 
...
-- Những học sinh có họ tên chứa chữ thị
select *  from hoc_sinh where ho_ten_hs like '%Thị%';
-- Những học sinh chưa  từ thị ở giữa(Không được chứa ở đầu và ơ cuối)
select * from hoc_sinh where ho_ten_hs like '%Thị%' and ho_ten_hs not like 'Thị%' and ho_ten_hs not like '%Thị';
-- Những học sinh có họ tên với độ dài là 30 kí tự (kể cả khoảng trắng)
select * from hoc_sinh where length(ho_ten_hs) = 30;
-- Những học sinh có họ tên với độ dài tối đa 30 kí tự
select * from hoc_sinh where length(ho_ten_hs) <= 30;
-- Những học sinh có họ tên với độ dài tối đa 30 kí tự và bắt đầu bằng kí tự N
select * from hoc_sinh where length(ho_ten_hs) <= 30 And ho_ten_hs like 'N%';
-- Những học sinh có họ tên băt đầu bằng N,T,V
select * from hoc_sinh where ho_ten_hs like 'N%' or ho_ten_hs like 'T%' or ho_ten_hs like 'V%';
-- Những học sinh có họ tên không băt đầu bằng N,T,V
select * from hoc_sinh where ho_ten_hs not like 'N%' or ho_ten_hs not like 'T%' or ho_ten_hs not like 'V%';
-- Những học sinh có họ tên với phần họ có đúng 4 kí tựa
