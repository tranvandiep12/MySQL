...
-- Những học sinh nữ ở địa chỉ thanh khê 
select * from hoc_sinh where gioi_tinh = 'Nữ' And dia_chi = 'Thanh Khê';
-- Những học sinh nam có địa chỉ ở hải châu hoặc những học sinh nữ ở địa chỉ thanh khê
...
select * from hoc_sinh where (gioi_tinh = 'Nam' And ma_lop is null And ho_ten_ph is null);
-- Mã môn học những môn được dạy trong học kỳ 2
