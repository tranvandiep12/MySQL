...
-- Liệt kê thông tin học sinh lớp học và gvcn
select hs.ma_hs, hs.ho_ten_hs , hs.gioi_tinh , lop.ten_lop , lop.ma_gvcn , hs.ma_lop
from hoc_sinh hs
inner join lop on hs.ma_lop = lop.ma_lop;
-- Liệt kê thông tin học sinh, kết quả học tập và môn học
select hs.ma_hs, hs.ho_ten_hs, kq.hoc_ky, kq.ma_mh, kq.diem_thi_giua_ky, kq.diem_thi_cuoi_ky
from hoc_sinh hs
inner join ket_qua_hoc_tap kq on hs.ma_hoc_sinh = kq.ma_hoc_sinh;

-- Liệt kê thông tin giáo viên phụ trách bộ môn
